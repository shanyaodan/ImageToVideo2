...
public class VideoEncoderCore {
    ...
    public static final int FRAME_RATE = 30;               // 10fps
    ...
    public static int audioRate = 32000;   //音频编码的密钥比特率
    ...
    public static int videBitrate = 2400_000;
    ...
    public VideoEncoderCore(int width, int height, int bitRate, String path)
        ...
        aFormat.setInteger(MediaFormat.KEY_BIT_RATE, audioRate);//比特率
                try {
                    ...
                    L.i(TAG,"MediaCodec mAudioEnc create ok");
                } catch (IOException e) {
                    e.printStackTrace();
                    L.i(TAG,"MediaCodec mAudioEnc createfial");
                }
        ...
        mAudioEnc.start();
        L.i(TAG,"MediaCodec mAudioEnc start");
        mRecorder.startRecording();
        L.i(TAG,"AudioRecord start");
        //video init
        mBufferInfo = new MediaCodec.BufferInfo();
//        if(height>width) {
//            width = (int) (960f / height * width);
//            height = 960;
//        }else {
//            height = (int) (960f/width*height);
//            width = 960;
//        }
//       Log.e("VideoEncoderCore","wwwwwwwwwwidth"+width);
...
//        format.setInteger(MediaFormat.KEY_ROTATION, IFRAME_INTERVAL);
        ...
        // we can use for input and wrap it with a class that handles the EGL work.
                try {
                    ...
                    L.i(TAG,"mVideoEncoder create ok");
                } catch (IOException e) {
                    e.printStackTrace();
                    L.i(TAG,"mVideoEncoder create fail");
                }

                mVideoEncoder.configure(format, null, null, MediaCodec.CONFIGURE_FLAG_ENCODE);
        mInputSurface = mVideoEncoder.createInputSurface();
        mVideoEncoder.start();
        L.i(TAG,"mVideoEncoder start");
        ...
        // the raw H.264 elementary stream we get from MediaCodec into a .mp4 file.
                try {
                    ...
                    L.i(TAG,"MediaMuxer create ok");
                } catch (IOException e) {
                    e.printStackTrace();
                    L.i(TAG,"MediaMuxer create fail");
                }
    ...
    public void drainEncoder(boolean endOfStream) {
        ...
        if (VERBOSE) L.i(TAG, "drainEncoder(" + endOfStream + ")");
        ...
        while (true) {
            ...
            if (encoderStatus == MediaCodec.INFO_TRY_AGAIN_LATER) {
                ...
                if (!endOfStream) {
                    ...
                    if (VERBOSE) L.i(TAG, "no output available, spinning to await EOS");
                }
...
//                    encodedData.limit(mBufferInfo.offset + mBufferInfo.size);
                ...
                if ((mBufferInfo.flags & MediaCodec.BUFFER_FLAG_END_OF_STREAM) != 0) {
                    if (!endOfStream) {
                        ...
                        if (VERBOSE)  L.i(TAG, "end of stream reached");
                    }
                    break;      // out of while
                }
            }
...
//    }
    ...
    class AudioEncoder implements Runnable {
        ...
        @Override
        public void run() {
            L.i(TAG,"AudioEncoder thread run");
            Looper.prepare();
            mHandler = new AudioHandler(this);
            L.i(TAG,"AudioEncoder thread in looper");
            synchronized (mReadyFence){
                isReady=true;
                L.i(TAG,"AudioEncoder thread mReadyFence.notify");
                mReadyFence.notify();
            }
            Looper.loop();
            synchronized (mReadyFence){
        ...
        public void startRecord() {
            synchronized (mReadyFence){
                if(!isReady){
                    try {
                        L.i(TAG,"startRecord mReadyFence.wait 音频等待");
                        mReadyFence.wait();
        ...
        public void handleStartRecord() {
            ...
            L.i(TAG,"handleStartRecord MSG_AUDIO_STEP");
            L.i(TAG,"cancelFlag="+cancelFlag+"   pausing="+pausing+"   isRecording"+isRecording);
                ...
                if (!cancelFlag) {
                    if (!pausing) {
                        if (isRecording) {
                            ...
                            Log.e(TAG,"handleAudioStep !isRecording");
                            drainEncoder();
        ...
        public void handleStopRecord() {
            isRecording = false;
            L.i(TAG,"handleStopRecord isRecording="+isRecording);
        }
...
//            Log.e(TAG,"audioStep");
            ...
            if (index >= 0) {
                ...
                if (AudioRecord.ERROR_INVALID_OPERATION == length) {
                   L.i(TAG,"ERROR_INVALID_OPERATION 录音不可用");
                    mAudioEnc.releaseOutputBuffer(index, false);

//                    recordListener.onError(1);
                    return  true;
                }
            ...
            do {
                ...
                if (outIndex >= 0) {
                    ...
                    synchronized (lock) {
                        ...
                        L.i(TAG, "add audio track-->" + mAudioTrackIndex);
        ...
        public void handleMessage(Message msg) {
            ...
            switch (what) {
                ...
                case MSG_RESUME:
                    ...
                    break;
                case MSG_QUIT:
                    L.i(TAG,"AudioEncoder Looper.myLooper().quit()");
